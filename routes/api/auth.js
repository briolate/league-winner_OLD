...
// @desc     Test route
// @access   Public
router.get("/", auth_1.default, function (expressRequest, res) { return __awaiter(void 0, void 0, void 0, function () {
    var req, user, err_1;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 3:
                ...
                jsonwebtoken_1.default.sign(payload, config_1.default.get("jwtSecret"), { expiresIn: 3600 }, function (err, token) {
                    if (err)
                        throw err;
